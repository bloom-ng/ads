    ...
    <section class="bg-white">
        ...
        <section class="flex flex-col w-full items-center">
            ...
            <div class="absolute bg-gradient-to-r from-[#FFE5C680] to-[#FFBB6780] p-20 lg:w-[40%] rounded-3xl items-center text-center mt-24">
               ...
               <form class="space-y-6 w-full lg:px-5" method="POST" action="{{ route('login') }}">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" class="w-full p-2 px-5 border border-[#000000] rounded-xl" 
